...
while True:
    ...
    if  note_create == "да":
        ...
        while True:
            note_created_date = input("Введите дату создания заметки (В формате: дд-мм-гггг. Например: 16-01-2025): ")
            ...
            try: # Запускаем проверку введенной даты соответствию требуемых параметров ввода
                ...
                # корректные данные
                print("Вы ввели неверную дату. Пожалуйста введите дату в формате дд-мм-гггг. Например: 16-01-2025")
        ...
        while True:
            ...
            try: # Запускаем проверку введенной даты соответствию требуемых параметров ввода
                ...
                # корректные данные
                print("Вы ввели неверную дату. Пожалуйста введите дату в формате дд-мм-гггг. Например: 18-01-2025")
